...
export default function (props) {
		...
		return (
			<Col span={d.col} key={d.panelId}>
				<div className="iframe-item" style={{ height: `${height}px` }}>
					<Iframe
						url={`${d.url}&refresh=30s&from=1574835182181&to=1574921582181&var-cluster=fzzj_redis_${clusterName}_${clusterId}&var-instance=${ip}:${port}&theme=light&panelId=${d.panelId}`}
					/>
				</div>
			</Col>
		);
	...
	return (
		<>
			{renderIframes(nodeMonitorArrayData)}
		</>
	);
}
